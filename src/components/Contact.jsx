...
const Contact = () => {
  return (
    <div name='contact' className='w-full md:h-screen bg-[#0a192f] text-gray-300'>
        <div className='max-w-[1000px] mx-auto p-4 pt-48 md:pt-0 flex flex-col justify-center w-full h-full'>
            <div>
                <p className='text-4xl font-bold inline border-b-4 border-[#26c2a8]'>Contact</p>
                <p className='py-4 mb-3'>Fill out the form to reach me</p>
            </div>
            <div>
                <form action="https://getform.io/f/434a7b43-49d3-4f89-a78d-a3285cee451d" method='POST' encType='multipart/form-data'>
                    ...
                    <div className='flex flex-col py-2'>
                        <textarea className='border-2 rounded-lg p-3 border-[#64FFDA] bg-gray-700 ' rows='6' name='message' placeholder="Write your message here..."></textarea>
                    </div>
